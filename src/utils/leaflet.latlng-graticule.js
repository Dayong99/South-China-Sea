  ...
  L.LatLngGraticule = L.Layer.extend({
      ...
      _animateZoom: function(e) {
          var map = this._map;
              ...
              var se = map.containerPointToLatLng([canvas.width, canvas.height]);
      ...
      __draw: function(label) {
          ...
          var self = this;
              var canvas = this._canvas;
              var map = this._map;
              var curvedLon = this.options.lngLineCurved;
              var curvedLat = this.options.latLineCurved;
          ...
          if (L.Browser.canvas && map) {
              ...
              var ll; var latstr; var lngstr; var _lon_delta = 0.5;
